...
class MainWindow(QWidget) :
    ...
    def setTabUI(self):
        ...
        # tabs = QTabWidget()
        item_layout = self.item_layout_UI()
        ...
        layout_to_set.addWidget(item_layout)
    ...
    def item_layout_UI(self):
        ...
        for module in module_path:
            ...
            # #SET ITEM GROUP ---------------------------------------------------------------------------------------------------------------------------------------------------
            # layoutItem = FlowLayout()
            # n.addLayout(layoutItem)
            # #New Chara Button
            # self.new_item_BTN.setFixedSize(100, 100)
            # grid.addWidget(self.new_item_BTN)
